    ...
    <div class="container">
        ...
        <div class="form__div">
            ...
            <div class="lain">
                ...
                <input type="text" id="writerId" readonly v-model="review.writerId" class="form__input input"
                    :placeholder="store.review.writerId">
            </div>
            <div class="lain">
            ...
            <div class="buttonarea">
                <button class="search-btn" @click="updateReview">수정</button>
            </div>
        </div>
    </div>
</template>
...
const updateReview = function () {
    store.updateReview(review, route.params.id)
}
onMounted(() => {
    const route = useRoute()
